...
![Создание каталога](image/01.jpg){ #fig:001 width=70% height=70% }
...
![Работа в редакторе Vi](image/02.jpg){ #fig:002 width=70% height=70% }

8. Сделаем наш файл исполняемым и попытаемся его исполнить.

![Запуск файла](image/03.jpg){ #fig:003 width=70% height=70% }
...
![Работа в редакторе Vi](image/04.jpg){ #fig:004 width=70% height=70% }

![Повторный запуск файла](image/05.jpg){ #fig:005 width=70% height=70% }
